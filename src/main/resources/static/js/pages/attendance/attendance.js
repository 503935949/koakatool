...
$(function(){
    ...
    $("#getPostponeInfoXls").on("click",function(e){
    ...
    $("#getOvertimeInfoXls").on("click",function(e){
        //var datas = $('#userGrid').bootstrapTable('getData');
        if($( "#startTime" ).val()==""||$( "#startTime" ).val()==null||
            $( "#endTime" ).val()==""||$( "#endTime" ).val()==null){
            alert("请点选择时间区间");
        ...
        alert("开始导出信息，点击确认 如若长时间没有文件则查看LOG文件查看错误");
        downloadFile(contextPath+"/attendance/getOverSumInfosEtInfo?"+$("#searchForm").serialize());
    });

    $("#getOverNightInfoXls").on("click",function(e){
        //var datas = $('#userGrid').bootstrapTable('getData');
        if($( "#startTime" ).val()==""||$( "#startTime" ).val()==null||
            $( "#endTime" ).val()==""||$( "#endTime" ).val()==null){
            alert("请点选择时间区间");
        ...
        alert("开始导出信息，点击确认 如若长时间没有文件则查看LOG文件查看错误");
        downloadFile(contextPath+"/attendance/getOverNightInfosEtInfo?"+$("#searchForm").serialize());
    });

    $("#getQxwxWorkflowEtInfo").on("click",function(e){
        //var datas = $('#userGrid').bootstrapTable('getData');
        if($( "#startTime" ).val()==""||$( "#startTime" ).val()==null||
            $( "#endTime" ).val()==""||$( "#endTime" ).val()==null){
            alert("请点选择时间区间");
        ...
        alert("开始导出信息，点击确认 如若长时间没有文件则查看LOG文件查看错误");
        downloadFile(contextPath+"/attendance/getQxwxWorkflowEtInfo?"+$("#searchForm").serialize());
    });
